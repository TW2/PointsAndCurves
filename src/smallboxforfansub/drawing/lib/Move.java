...
/**
 * Move est une fausse forme, elle ne sert qu'à décaler le point et créer
 * un nouveau chemin.
 * @author The Wingate 2940
 */
public class Move extends AShape implements Cloneable {
    ...
    public Move(int originX1, int originY1, int lastX2, int lastY2){
        rect.setRect(
    ...
    public String getCommand() {
        return "n "+(int)last.getX()+" "+(int)last.getY();
    }
