 ...
 */
public class BSpline extends AShape implements Cloneable {
    
    //Les points de coordonnées 'origine' et 'dernier'.
    java.awt.Point nc, next;
    ...
    List<ControlPoint> lcp = new ArrayList<>();
    ...
    public void updatePoint(int x, int y){
        ...
        List<Point2D> lsp = new ArrayList<>();
