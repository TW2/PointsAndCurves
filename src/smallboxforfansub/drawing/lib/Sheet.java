...
public class Sheet extends javax.swing.JPanel {
    ...
    private java.util.List<Center> centers = new java.util.ArrayList<>();
    private java.util.List<Resize> resizes = new java.util.ArrayList<>();
    private java.util.List<Shear> shears = new java.util.ArrayList<>();
