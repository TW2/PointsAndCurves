...
import smallboxforfansub.drawing.adf.DrawingObject;
import smallboxforfansub.drawing.adf.LayerContent;
import smallboxforfansub.drawing.adf.XmlDrawingHandler;
import smallboxforfansub.drawing.adf.XmlDrawingWriter;
import smallboxforfansub.drawing.dialog.OpenGlyphDialog;
import smallboxforfansub.drawing.dialog.RotationDialog;
import smallboxforfansub.drawing.dialog.SelectGeoDialog;
import smallboxforfansub.filter.AssFilter;
import smallboxforfansub.filter.DrawingFilter;
import smallboxforfansub.filter.ImageFilter;
import smallboxforfansub.filter.SVGFilter;
import smallboxforfansub.drawing.lib.*;
...
import smallboxforfansub.drawing.ornament.AShape;
import smallboxforfansub.drawing.ornament.AssLine;
import smallboxforfansub.drawing.ornament.OrnControlPoint;
import smallboxforfansub.drawing.ornament.OrnDo;
import smallboxforfansub.drawing.ornament.OrnLayer;
import smallboxforfansub.drawing.ornament.OrnMMBezier;
import smallboxforfansub.drawing.ornament.OrnMMLine;
import smallboxforfansub.drawing.ornament.OrnPoint;
import smallboxforfansub.drawing.preview.DrawingPreview;
import smallboxforfansub.drawing.preview.ImagePreview;
import smallboxforfansub.drawing.renderer.LayerRenderer;
import smallboxforfansub.drawing.renderer.RememberRenderer;
...
public class DrawingPanel extends javax.swing.JPanel {
    ...
    private drawing.Language localeLanguage;
     ...
     */
    public DrawingPanel(String docs, Frame frame, drawing.Language lang) {
        initComponents();
        localeLanguage = lang;
        init();
        this.docs = docs;
...
//            case Scale : ifrScale.setTitle(translation); break;
    ...
    private void setLanguageAndConfigure(drawing.Language lang){
        ...
        if(localeLanguage.getValueOf("assSketchpadPointsBL")!=null){
            popmAddPointsBL.setText(localeLanguage.getValueOf("assSketchpadPointsBL"));}
        if(localeLanguage.getValueOf("assSketchpadPointsBC")!=null){
            popmAddPointsBC.setText(localeLanguage.getValueOf("assSketchpadPointsBC"));}
        if(localeLanguage.getValueOf("assSketchpadPointsBLC")!=null){
            popmAddPointsBLC.setText(localeLanguage.getValueOf("assSketchpadPointsBLC"));}
        if(localeLanguage.getValueOf("assSketchpadPointsBCL")!=null){
            popmAddPointsBCL.setText(localeLanguage.getValueOf("assSketchpadPointsBCL"));}
        if(localeLanguage.getValueOf("assSketchpadPointsLine")!=null){
            popmRemovePointsLine.setText(localeLanguage.getValueOf("assSketchpadPointsLine"));}
        if(localeLanguage.getValueOf("assSketchpadPointsCurve")!=null){
            popmRemovePointsCurve.setText(localeLanguage.getValueOf("assSketchpadPointsCurve"));}
        if(localeLanguage.getValueOf("ifrScript")!=null){
            ifrScript.setTitle(localeLanguage.getValueOf("ifrScript"));}
        if(localeLanguage.getValueOf("ifrAssCommands")!=null){
            ifrAssCommands.setTitle(localeLanguage.getValueOf("ifrAssCommands"));}
    }
    ...
    private void initComponents() {
        ...
        popmColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_app_kcoloredit.png"))); // NOI18N
        ...
        popmName.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_editcopy.png"))); // NOI18N
        ...
        popmPenSize2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 01.png"))); // NOI18N
        ...
        popmPenSize4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 02.png"))); // NOI18N
        ...
        popmPenSize6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 03.png"))); // NOI18N
        ...
        popmPenSize8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 04.png"))); // NOI18N
        ...
        popmPenSize10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 05.png"))); // NOI18N
        ...
        popmPenColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_app_kcoloredit.png"))); // NOI18N
        ...
        popmLayerColor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_app_kcoloredit.png"))); // NOI18N
        ...
        popmLayerName.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_editcopy.png"))); // NOI18N
        ...
        popmDuplicateLayer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/funsub-dupliquer.png"))); // NOI18N
        ...
        popmClearSketch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_button_cancel.png"))); // NOI18N
        ...
        popmSelectionCopyPaste.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionSym.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo1A.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo1B.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo2A.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo2B.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo3A.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeo3B.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmSelectionGeoPlus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Selection.png"))); // NOI18N
        ...
        popmAddPointsBL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_add2.png"))); // NOI18N
        ...
        popmAddPointsBC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_add2.png"))); // NOI18N
        ...
        popmAddPointsBLC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_add2.png"))); // NOI18N
        ...
        popmAddPointsBCL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_add2.png"))); // NOI18N
        ...
        popmRemovePointsLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_remove2.png"))); // NOI18N
        ...
        popmRemovePointsCurve.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20px-Crystal_Clear_action_edit_remove2.png"))); // NOI18N
        ...
        popmRubberSize2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 01.png"))); // NOI18N
        ...
        popmRubberSize4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 02.png"))); // NOI18N
        ...
        popmRubberSize6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 03.png"))); // NOI18N
        ...
        popmRubberSize8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 04.png"))); // NOI18N
        ...
        popmRubberSize10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/20 piceau 05.png"))); // NOI18N
        ...
        btnNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_action_filenew.png"))); // NOI18N
        ...
        btnOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_filesystem_folder_grey_open.png"))); // NOI18N
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_device_floppy_unmount.png"))); // NOI18N
        ...
        btnOpenFonts.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_mimetype_font_type1.png"))); // NOI18N
        ...
        tbShapeLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingLine.png"))); // NOI18N
        ...
        tbShapeBezier.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingBezier.png"))); // NOI18N
        ifrMainDraw.getContentPane().add(tbShapeBezier);
        tbShapeBezier.setBounds(40, 0, 40, 40);

        bgDraw.add(tbFreeDrawing);
        tbFreeDrawing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32-Crayon.png"))); // NOI18N
        ...
        tbFreeClear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32-Gomme.png"))); // NOI18N
        ...
        tbShapeBSpline1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingBSpline.png"))); // NOI18N
        ifrMainDraw.getContentPane().add(tbShapeBSpline1);
        tbShapeBSpline1.setBounds(0, 40, 40, 40);

        bgDraw.add(tbNextPoint);
        tbNextPoint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-NextAfterBSpline.png"))); // NOI18N
        ifrMainDraw.getContentPane().add(tbNextPoint);
        tbNextPoint.setBounds(80, 40, 40, 40);

        bgDraw.add(tbReStart);
        tbReStart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/move m.png"))); // NOI18N
        ifrMainDraw.getContentPane().add(tbReStart);
        tbReStart.setBounds(0, 80, 40, 40);

        bgDraw.add(tbMove);
        tbMove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/move n.png"))); // NOI18N
        ifrMainDraw.getContentPane().add(tbMove);
        tbMove.setBounds(40, 80, 40, 40);

        btnCloseBSpline.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingCloseBSpline.png"))); // NOI18N
        ...
        btnUnloadImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_app_windows_users.png"))); // NOI18N
        ...
        btnImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_app_kpaint.png"))); // NOI18N
        ...
        btnTopImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/f02.gif"))); // NOI18N
        ...
        btnCentreImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/f05.gif"))); // NOI18N
        ...
        btnLeftImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/f04.gif"))); // NOI18N
        ...
        btnRightImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/f06.gif"))); // NOI18N
        ...
        btnBottomImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/f08.gif"))); // NOI18N
        ...
        tbNormalMode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32-Rose.png"))); // NOI18N
        ...
        tbOrnamentMode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32-ornement.png"))); // NOI18N
        ...
        tbTranslation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-translate.png"))); // NOI18N
        ifrOperations.getContentPane().add(tbTranslation);
        tbTranslation.setBounds(0, 0, 40, 40);

        bgDraw.add(tbRotation);
        tbRotation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-rotate.png"))); // NOI18N
        ifrOperations.getContentPane().add(tbRotation);
        tbRotation.setBounds(40, 0, 40, 40);

        bgDraw.add(tbResize);
        tbResize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-scale.png"))); // NOI18N
        ifrOperations.getContentPane().add(tbResize);
        tbResize.setBounds(80, 0, 40, 40);

        bgDraw.add(tbShear);
        tbShear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-shear.png"))); // NOI18N
        tbShear.setEnabled(false);
        ifrOperations.getContentPane().add(tbShear);
        tbShear.setBounds(120, 0, 40, 40);

        bgDraw.add(tbSelection);
        tbSelection.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Selection.png"))); // NOI18N
        ...
        javax.swing.GroupLayout ifrScriptLayout = new javax.swing.GroupLayout(ifrScript.getContentPane());
        ifrScript.getContentPane().setLayout(ifrScriptLayout);
        ifrScriptLayout.setHorizontalGroup(
            ifrScriptLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrScriptLayout.createSequentialGroup()
                .addComponent(btnApplyScript, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(jScrollPane1)
        );
        ifrScriptLayout.setVerticalGroup(
            ifrScriptLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrScriptLayout.createSequentialGroup()
                .addComponent(btnApplyScript, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnHistorique.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_action_back.png"))); // NOI18N
        ...
        btnRedo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/32px-Crystal_Clear_action_forward.png"))); // NOI18N
        ...
        javax.swing.GroupLayout ifrHistoricLayout = new javax.swing.GroupLayout(ifrHistoric.getContentPane());
        ifrHistoric.getContentPane().setLayout(ifrHistoricLayout);
        ifrHistoricLayout.setHorizontalGroup(
            ifrHistoricLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrHistoricLayout.createSequentialGroup()
                .addComponent(btnHistorique, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(btnRedo, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(jScrollPane2)
        );
        ifrHistoricLayout.setVerticalGroup(
            ifrHistoricLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrHistoricLayout.createSequentialGroup()
                .addGroup(ifrHistoricLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnHistorique, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnRedo, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        javax.swing.GroupLayout ifrLayersLayout = new javax.swing.GroupLayout(ifrLayers.getContentPane());
        ifrLayers.getContentPane().setLayout(ifrLayersLayout);
        ifrLayersLayout.setHorizontalGroup(
            ifrLayersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrLayersLayout.createSequentialGroup()
                .addComponent(btnAddLayer, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(btnDeleteLayer, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(jScrollPane3)
        );
        ifrLayersLayout.setVerticalGroup(
            ifrLayersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ifrLayersLayout.createSequentialGroup()
                .addGroup(ifrLayersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnAddLayer, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnDeleteLayer, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tbOrnMMLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingLine-OrnMainMove.png"))); // NOI18N
        ...
        tbOrnMMBezier.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingBezier-OrnMainMove.png"))); // NOI18N
        ...
        tbOrnMMBSpline.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/AFM-DrawingBSpline-OrnMainMove.png"))); // NOI18N
        ...
        btnOrnMMClear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/smallboxforfansub/images/edit-clear-4.png"))); // NOI18N
...
//            int ya = evt.getYOnScreen()-(int)sh.getLocationOnScreen().getY();
            ...
            for (smallboxforfansub.drawing.ornament.IShape s : ornlayForMain.getList()){
                for (smallboxforfansub.drawing.ornament.IShape sb : ornlayForMain.getChangeList()) {
                    if (s.equals(sb)){
                        s.setMarked(true);
                        sb.setMarked(true);
                    }
                ...
                if (z == JFileChooser.APPROVE_OPTION){
                    try{
                        ...
                        for(int i=0; i<dtmOrnForMain.getRowCount(); i++){
                            smallboxforfansub.drawing.ornament.IShape s = (smallboxforfansub.drawing.ornament.IShape)dtmOrnForMain.getValueAt(i, 0);
