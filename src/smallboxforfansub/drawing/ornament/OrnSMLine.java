...
/**
 * Ornament Shape Move Line pour les mouvements de forme
 * @author The Wingate 2940
 */
public class OrnSMLine extends AShape {
    
    public OrnSMLine(){
        
    }
    
    public OrnSMLine(int originX1, int originY1, int lastX2, int lastY2){
