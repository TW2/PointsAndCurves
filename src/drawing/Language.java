...
//            return null;
    ...
    public void init(Locale loc){
        if (loc==Locale.US | loc==Locale.UK | loc==Locale.ENGLISH | loc==Locale.CANADA){
            ...
            LangUS.put("buttonContinue", "Continue");
            ...
            LangUS.put("messAbout", "<html><p align=\"center\"><b>Feuille</b> "
                    + "(Funsub project 2006-2013)<br />GNU/GPLv3 - Free and open for all."
                    + " <br />Feuille is an alien software. It's made to think differently."
                    + " And also for Windows, Linux and Mac OS X<br />Feuille project"
                    + " codename is SmallBoxForFansub so don't be surprised !<br />"
                    + "<i><b>Developed by The Wingate 2940 aka Chien-Rouge<br />"
            ...
            LangUS.put("ifrScript", "Your scripts");
            LangUS.put("ifrAssCommands", "ASS Commands");
            ...
            LangUS.put("assSketchpadPointsBL", "Add a point between two lines");
            LangUS.put("assSketchpadPointsBC", "Add a point between two curves");
            LangUS.put("assSketchpadPointsBLC", "Add a point between a line and a curve");
            LangUS.put("assSketchpadPointsBCL", "Add a point between a curve and a line");
            LangUS.put("assSketchpadPointsLine", "Remove or replace points by a line");
            LangUS.put("assSketchpadPointsCurve", "Remove or replace points by a curve");
        }else if (loc==Locale.FRANCE | loc==Locale.FRENCH | loc==Locale.CANADA_FRENCH){
            ...
            LangFR.put("buttonContinue", "Continuer");
            ...
            LangFR.put("messAbout", "<html><p align=\"center\"><b>Feuille</b> "
                    + "(Projet Funsub 2006-2013)<br />GNU/GPLv3 - Gratuit et ouvert pour tous."
                    + " <br />Feuille est un programme alien. Il est créé pour penser différemment."
                    + " <br />Et aussi pour Windows, Linux et Mac OS X<br />Le nom de code du projet"
                    + " Feuille est SmallBoxForFansub, que cela ne vous étonne pas !<br />"
                    + "<i><b>Développé par The Wingate 2940 alias Chien-Rouge<br />"
            ...
            LangFR.put("ifrScript", "Vos scripts");
            LangFR.put("ifrAssCommands", "Commandes ASS");
            ...
            LangFR.put("assSketchpadPointsBL", "Ajouter un point entre deux lignes");
            LangFR.put("assSketchpadPointsBC", "Ajouter un point entre deux courbes");
            LangFR.put("assSketchpadPointsBLC", "Ajouter un point entre une ligne et une courbe");
            LangFR.put("assSketchpadPointsBCL", "Ajouter un point entre une courbe et une ligne");
            LangFR.put("assSketchpadPointsLine", "Enlever ou remplacer des points par une ligne");
            LangFR.put("assSketchpadPointsCurve", "Enlever ou remplacer des points par une courbe");
